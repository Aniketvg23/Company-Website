...
export function SimpleProtectedRoute({ children, requireAuth = true }: ProtectedRouteProps) {
...
export function SimplePublicRoute({ children }: PublicRouteProps) {
  return <SimpleProtectedRoute requireAuth={false}>{children}</SimpleProtectedRoute>;
}
